...
* [US airline on-time performance data](https://raw.githubusercontent.com/JamesByers/Workshop-files/master/intro-to-visualization-with-tableau/284334620_T_ONTIME.csv)
  * Note that this is a 45Mb file that is to big to open with Excel.  It can be opened in Tableau however.  The file can be examined with a text editor such as Notepad (Windows) or TextEdit (Mac).
